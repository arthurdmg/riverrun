...
$exp = explode("/", $file4);
    ...
    $like = "<a href='like.php?file=$files'>like</a>";			

    echo "<a href='../FILES/$files'>$files</a> $filesize $like</br>";
    ...
    echo "<a href='../FILES/$files'><img src='../FILES/$files' width='47%' height='47%' alt='$files'></a> $like ";
    ...
    echo "</br><a href='../FILES/$files'>$files</a> $like</br>";
